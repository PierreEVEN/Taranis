...
namespace Engine
{
	...
	{
		VK_CHECK(glfwCreateWindowSurface(instance_ref.lock()->raw(), window.lock()->raw(), nullptr, &ptr),
	...
	void Surface::set_renderer(const std::shared_ptr<RenderPass>& present_pass)
	{
