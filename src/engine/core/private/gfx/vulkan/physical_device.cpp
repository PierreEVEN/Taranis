...
Result<PhysicalDevice> PhysicalDevice::pick_best_physical_device(const std::weak_ptr<Instance>& instance, const Config& config, const std::shared_ptr<Surface>& surface)
{
