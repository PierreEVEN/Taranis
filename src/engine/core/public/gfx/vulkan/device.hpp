...
class Device : public std::enable_shared_from_this<Device>
{
  ...
  public:
    static std::shared_ptr<Device> create(const Config& config, const Instance& instance, const PhysicalDevice& physical_device, const Surface& surface);
    ~Device();
  ...
  private:
    Device(const Config& config, const Instance& instance, const PhysicalDevice& physical_device, const Surface& surface);
