...
{
    VkFenceCreateInfo create_infos = {.sType = VK_STRUCTURE_TYPE_FENCE_CREATE_INFO, .flags = signaled ? static_cast<VkFenceCreateFlags>(VK_FENCE_CREATE_SIGNALED_BIT) : static_cast<VkFenceCreateFlags>(0)};
