...
public:
    ...
    void init(const Eng::Gfx::RenderPassInstance& rp) override
    {
        ...
        std::shared_ptr<Eng::Gfx::Pipeline>     pipeline_cmaa2_edges_color_2x2 =
            Eng::Gfx::Pipeline::create("cmaa2_edges_color_2x2", Eng::Engine::get().get_device(), Eng::Engine::get().get_device().lock()->get_render_pass("cmaa2"), {sm_cmaa2_edges_color_2x2}, Eng::Gfx::Pipeline::CreateInfos{});
        ...
        std::shared_ptr<Eng::Gfx::Pipeline> pipeline_cmaa2_compute_dispatch_args = Eng::Gfx::Pipeline::create(
            "cmaa2_compute_dispatch_args", Eng::Engine::get().get_device(), Eng::Engine::get().get_device().lock()->get_render_pass("cmaa2"), {sm_cmaa2_compute_dispatch_args}, Eng::Gfx::Pipeline::CreateInfos{});
